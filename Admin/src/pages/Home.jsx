...
const Home = () => {
    ...
    return (
        <div className="flex justify-between h-screen p-2 bg-gray-200">
            ...
            <div className="flex flex-col w-[700px] bg-white p-5 shadow-xl rounded-lg">
                ...
                <div className="bg-gray-50 h-[400px] w-[600px] p-5 shadow-xl rounded-lg flex items-center justify-center">
                    <LineChart
