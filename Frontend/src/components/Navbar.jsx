  ...
  return (
    <div className="flex items-center justify-between h-[100px] bg-white shadow-md px-6">
      ...
      <div className="cursor-pointer m-2">
        <Link to="/">
          <img src="/skinlogo1.png" height="150px" width="200px" alt="Logo" />
        </Link>
      </div>
      ...
      <div className="flex items-center space-x-4">
        ...
        {!user.currentUser ? (
          <Link
            to="/login"
            className="flex items-center space-x-2 border border-pink-300 p-2 rounded-lg hover:bg-pink-100 transition duration-300"
          >
