  ...
  return (
    <div className="bg-gray-100 px-[200px] h-[60vh] mt-[50px]">
      <div className="flex justify-between py-[5%]">
        <div>
          <img src="/skinlogo1.png" alt="" height={200} width={200} />
        ...
        <div className="w-full md:w-1/3">
          ...
          <p className="mt-2">123 Gulshan Ave, Dhaka, Bangladesh</p>
          <p className="mt-2">Phone: (123) 456-7890</p>
          <p className="mt-2">Email: info@skinsavvy.com</p>
        </div>
      </div>
      <div className="mt-8 border-t border-[#e9acd9] pt-4 text-center">
        <p>&copy; 2025 SkinSavvy. All rights reserved.</p>
